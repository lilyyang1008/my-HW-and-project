...
int main()
{
    ...
    if (!backgroundtexture.loadFromFile("D:\\mini_project\\material\\background.png"))
    {
        return EXIT_FAILURE;
    }
    sf::Texture yellowTexture;
    if (!yellowTexture.loadFromFile("D:\\mini_project\\material\\yellow.png"))
    {
        return EXIT_FAILURE;
    }
    sf::Texture lightbluetexture;
    if (!lightbluetexture.loadFromFile("D:\\mini_project\\material\\light_blue.png"))
    {
        return EXIT_FAILURE;
    }
    sf::Texture greentexture;
    if (!greentexture.loadFromFile("D:\\mini_project\\material\\green.png"))
    {
        return EXIT_FAILURE;
    }
